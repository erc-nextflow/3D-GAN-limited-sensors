...
def main():
    ...
    ckpt_file = f"{root_folder}/models/checkpoints_{model_name}/ckpt-19" #1->19 3->14
...
if __name__ == '__main__':
    ...
    LZ = np.pi / 2
    learning_rate = 1e-4
    model_name = 'architecture-E01-1'  # change model name, architecture line 32, checkpoint line 51
    root_folder = '/    /'
