...
def main():
    ...
    ckpt_file = f"{root_folder}/models/checkpoints_{model_name}/ckpt-19" #1 ->19    3 >14    1-err1 ->16   1-err3  ->19
    ...
    #np.save('x_targetE01-1.npy', x_target)
    #savemat('x_targetE01-1.mat', {'x_target': x_target}) # save this in other code with smaller files
...
if __name__ == '__main__':
    ...
    LZ = np.pi / 2
    learning_rate = 1e-4
    err = 0.03  # noise level for testing
    # model name: 'architecture-E01-1', 'architecture-E01-1-err1', 'architecture-E01-1-err3'
    model_name = 'architecture-E01-1-err3'  # change model name, architecture line 32, checkpoint line 51
    root_folder = '/    /'
