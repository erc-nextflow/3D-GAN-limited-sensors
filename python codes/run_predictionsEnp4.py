...
def main():
    ...
    ckpt_file = f"{root_folder}/models/checkpoints_{model_name}/ckpt-16" #E4-1: 16    E4-2: 5    E4-3:18
...
if __name__ == '__main__':
    ...
    LZ = np.pi / 2
    learning_rate = 1e-4
    model_name = 'architecture-E04-1'  # change model name, architecture line 32, checkpoint line 51
    root_folder = '/    /'
