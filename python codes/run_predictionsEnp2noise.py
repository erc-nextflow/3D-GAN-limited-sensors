...
def main():
    ...
    ckpt_file = f"{root_folder}/models/checkpoints_{model_name}/ckpt-19" #  1->19    2->10   3->17
...
if __name__ == '__main__':
    ...
    learning_rate = 1e-4
    err = 2 * 0.03 
    model_name = 'architecture-E02-1'  # change model name, architecture line 32, checkpoint line 51
    root_folder = '/    /'
