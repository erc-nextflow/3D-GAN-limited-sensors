...
def main():
    ...
    ckpt_file = f"{root_folder}/models/checkpoints_{model_name}/ckpt-18" #  1->18    2->8   3->15
...
if __name__ == '__main__':
    ...
    learning_rate = 1e-4
    err = 4 * 0.03
    model_name = 'architecture-E03-1'  # change model name, architecture line 32, checkpoint line 51
    root_folder = '/    /'
